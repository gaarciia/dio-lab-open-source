...
> [!NOTE]   
> Por exemplo, a URL https://github.com/gaarciia/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "gaarciia" para a contribuição no repositório `dio-lab-open-source`.
